...
def train_model(dropout,l2_reguliser,lr,batch_size):
    ...
    model.save(f'output_model_One_Bi-LSTM_epochs10_all_data_{dropout}_{l2_reguliser}_{lr}_{batch_size}')
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'output_model_One_Bi-LSTM_epochs10_all_data_{dropout}_{l2_reguliser}_{lr}_{batch_size}.png')
    plt.close()
